...
Welcome to my corner of the internet where scalable architecture meets clean code! I'm a Full-Stack Engineer who gets genuinely excited about microservices, distributed systems, and making computers do impossible things at scale. With a strong foundation in data structures and algorithms, and hands-on experience leading full-scale projects, I work at the intersection of scale, performance, and clean architecture.
...
- 🎖️ **LeetCode Knight** with 1900 rating (Top 4% globally) - because algorithms are my playground
- 🔥 Led full-stack development - reduced API load by **80%** and mentored team of 3 developers

## 🌟 Featured Projects

### [RentEzy](https://github.com/AdilAbubacker/rentezy_backend)
A  proptech masterpiece with 10+ independently horizontally scalable microservices featuring automated recurring rent payment system, real-time chat, visit-scheduling, event-driven notifications, concurrency-safe booking and more. Built with Django, React, Kafka, Celery, Elasticsearch and deployed on AWS EKS. Because why make it simple when you can make it scalable?
